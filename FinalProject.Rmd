...
finances$ENROLL <- as.numeric(finances$ENROLL)
finances$OTHER_EXPENDITURE <- as.numeric(finances$OTHER_EXPENDITURE)
...
# MACHINE LEARNING
task <- mlr::makeClassifTask(id = "US Finances", data = us_finances, target = "unemployment", positive = "TRUE")
...
#Read the csv file
Unemployment <- read.csv("./data/merged_dataset.csv",head=TRUE, sep=";",dec=",")
